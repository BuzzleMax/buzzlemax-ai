...
export const PRICING_PLANS = [
  {
    ...
    price: 250,
    period: 'month',
    description: 'Essential AI automation to get started with intelligent customer interactions.',
    features: [
      'AI Chatbot',
      'Lead Capture',
  ...
  },
  {
    ...
    price: 700,
    period: 'month',
    description: 'Advanced automation across multiple channels for growing businesses.',
    features: [
  ...
  },
  {
    ...
    price: 1500,
    period: 'month',
    description: 'Complete AI automation ecosystem with custom solutions for large organizations.',
    features: [
