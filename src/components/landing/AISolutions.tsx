            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-0.5">
                  Have custom requirements? Book a 1-on-1 AI strategy audit with our team — starting at <span className="font-semibold text-foreground">₹5,000 (~$60)</span>. We'll map out exactly what to build for your business.
                </p>
              </div>
            </div>
            <Button
