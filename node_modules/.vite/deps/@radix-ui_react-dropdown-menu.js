...
import {
  ...
  useId,
  useLayoutEffect2
} from "./chunk-JSFS5TUD.js";
import {
  Primitive,
  dispatchDiscreteCustomEvent
} from "./chunk-LK5CLZGF.js";
import {
  createSlot,
  useComposedRefs
...
var Menu = __name3((props) => {
  ...
  const direction = useDirection(dir);
  React4.useEffect(() => {
    const handleKeyDown = __name3(() => {
      isUsingKeyboardRef.current = true;
      document.addEventListener("pointerdown", handlePointer, { capture: true, once: true });
      document.addEventListener("pointermove", handlePointer, { capture: true, once: true });
    }, "handleKeyDown");
    const handlePointer = __name3(() => isUsingKeyboardRef.current = false, "handlePointer");
  ...
  React4.useEffect(() => {
    ...
    const handleBlur = __name3(() => handleOpenChange(false), "handleBlur");
...
var MenuAnchor = React4.forwardRef(
  __name3(function MenuAnchor2(props, forwardedRef) {
...
var MenuContent = React4.forwardRef(
  __name3(function MenuContent2(props, forwardedRef) {
...
var MenuRootContentModal = React4.forwardRef(
  // blank line to reduce diff noise
  __name3(function MenuRootContentModal2(props, forwardedRef) {
    const context = useMenuContext(CONTENT_NAME, props.__scopeMenu);
...
var MenuRootContentNonModal = React4.forwardRef(__name3(function MenuRootContentNonModal2(props, forwardedRef) {
  const context = useMenuContext(CONTENT_NAME, props.__scopeMenu);
  return (0, import_jsx_runtime2.jsx)(
    MenuContentImpl,
    {
...
var MenuContentImpl = React4.forwardRef(
  // blank line to reduce diff noise
  __name3(function MenuContentImpl2(props, forwardedRef) {
    const {
      __scopeMenu,
      loop = false,
      trapFocus,
    ...
    const handleTypeaheadSearch = __name3((key) => {
      var _a, _b;
...
var MenuGroup = React4.forwardRef(
  __name3(function MenuGroup2(props, forwardedRef) {
...
var MenuLabel = React4.forwardRef(
  __name3(function MenuLabel2(props, forwardedRef) {
...
var MenuItem = React4.forwardRef(
  // blank line to reduce diff noise
  __name3(function MenuItem2(props, forwardedRef) {
...
var MenuItemImpl = React4.forwardRef(
  __name3(function MenuItemImpl2(props, forwardedRef) {
...
var MenuCheckboxItem = React4.forwardRef(
  // blank line to reduce diff noise
  __name3(function MenuCheckboxItem2(props, forwardedRef) {
...
var [RadioGroupProvider, useRadioGroupContext] = createMenuContext(
  RADIO_GROUP_NAME,
  { value: void 0, onValueChange: __name3(() => {
  }, "onValueChange") }
);
var MenuRadioGroup = React4.forwardRef(
  __name3(function MenuRadioGroup2(props, forwardedRef) {
...
var MenuRadioItem = React4.forwardRef(
  __name3(function MenuRadioItem2(props, forwardedRef) {
...
var MenuItemIndicator = React4.forwardRef(
  // blank line to reduce diff noise
  __name3(function MenuItemIndicator2(props, forwardedRef) {
...
var MenuSeparator = React4.forwardRef(
  __name3(function MenuSeparator2(props, forwardedRef) {
...
var MenuArrow = React4.forwardRef(
  __name3(function MenuArrow2(props, forwardedRef) {
...
var MenuSubTrigger = React4.forwardRef(
  __name3(function MenuSubTrigger2(props, forwardedRef) {
...
var MenuSubContent = React4.forwardRef(
  __name3(function MenuSubContent2(props, forwardedRef) {
    const portalContext = usePortalContext(CONTENT_NAME, props.__scopeMenu);
...
__name3(getOpenState, "getOpenState");
function isIndeterminate(checked) {
  return checked === "indeterminate";
}
__name3(isIndeterminate, "isIndeterminate");
function getCheckedState(checked) {
  return isIndeterminate(checked) ? "indeterminate" : checked ? "checked" : "unchecked";
}
__name3(getCheckedState, "getCheckedState");
...
__name3(focusFirst2, "focusFirst");
function wrapArray2(array, startIndex) {
  return array.map((_, index) => array[(startIndex + index) % array.length]);
}
__name3(wrapArray2, "wrapArray");
...
__name3(getNextMatch, "getNextMatch");
...
__name3(isPointerInGraceArea, "isPointerInGraceArea");
function whenMouse(handler) {
  return (event) => event.pointerType === "mouse" ? handler(event) : void 0;
}
__name3(whenMouse, "whenMouse");
var Root3 = Menu;
...
var DropdownMenu = __name4((props) => {
  const {
    __scopeDropdownMenu,
    children,
    dir,
...
var DropdownMenuTrigger = React5.forwardRef(
  // blank line to reduce diff noise
  __name4(function DropdownMenuTrigger2(props, forwardedRef) {
...
var DropdownMenuPortal = __name4((props) => {
...
var DropdownMenuContent = React5.forwardRef(
  // blank line to reduce diff noise
  __name4(function DropdownMenuContent2(props, forwardedRef) {
...
var DropdownMenuGroup = React5.forwardRef(
  // blank line to reduce diff noise
  __name4(function DropdownMenuGroup2(props, forwardedRef) {
...
var DropdownMenuLabel = React5.forwardRef(
  // blank line to reduce diff noise
  __name4(function DropdownMenuLabel2(props, forwardedRef) {
...
var DropdownMenuItem = React5.forwardRef(
  // blank line to reduce diff noise
  __name4(function DropdownMenuItem2(props, forwardedRef) {
    const { __scopeDropdownMenu, ...itemProps } = props;
    const menuScope = useMenuScope(__scopeDropdownMenu);
    return (0, import_jsx_runtime3.jsx)(Item2, { ...menuScope, ...itemProps, ref: forwardedRef });
  }, "DropdownMenuItem")
);
var DropdownMenuCheckboxItem = React5.forwardRef(__name4(function DropdownMenuCheckboxItem2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...checkboxItemProps } = props;
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime3.jsx)(CheckboxItem, { ...menuScope, ...checkboxItemProps, ref: forwardedRef });
}, "DropdownMenuCheckboxItem"));
var DropdownMenuRadioGroup = React5.forwardRef(__name4(function DropdownMenuRadioGroup2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...radioGroupProps } = props;
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime3.jsx)(RadioGroup, { ...menuScope, ...radioGroupProps, ref: forwardedRef });
}, "DropdownMenuRadioGroup"));
var DropdownMenuRadioItem = React5.forwardRef(__name4(function DropdownMenuRadioItem2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...radioItemProps } = props;
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime3.jsx)(RadioItem, { ...menuScope, ...radioItemProps, ref: forwardedRef });
}, "DropdownMenuRadioItem"));
var DropdownMenuItemIndicator = React5.forwardRef(__name4(function DropdownMenuItemIndicator2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...itemIndicatorProps } = props;
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime3.jsx)(ItemIndicator, { ...menuScope, ...itemIndicatorProps, ref: forwardedRef });
}, "DropdownMenuItemIndicator"));
var DropdownMenuSeparator = React5.forwardRef(__name4(function DropdownMenuSeparator2(props, forwardedRef) {
...
var DropdownMenuArrow = React5.forwardRef(
  // blank line to reduce diff noise
  __name4(function DropdownMenuArrow2(props, forwardedRef) {
    const { __scopeDropdownMenu, ...arrowProps } = props;
    const menuScope = useMenuScope(__scopeDropdownMenu);
    return (0, import_jsx_runtime3.jsx)(Arrow2, { ...menuScope, ...arrowProps, ref: forwardedRef });
  }, "DropdownMenuArrow")
);
var DropdownMenuSub = __name4((props) => {
...
var DropdownMenuSubTrigger = React5.forwardRef(__name4(function DropdownMenuSubTrigger2(props, forwardedRef) {
  const { __scopeDropdownMenu, ...subTriggerProps } = props;
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime3.jsx)(SubTrigger, { ...menuScope, ...subTriggerProps, ref: forwardedRef });
}, "DropdownMenuSubTrigger"));
var DropdownMenuSubContent = React5.forwardRef(__name4(function DropdownMenuSubContent2(props, forwardedRef) {
